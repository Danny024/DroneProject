...
from monoslam.pyslam import process_frame  # Assuming process_frame is a function from the SLAM package
...
class SlamPublisher(Node):
    ...
    def broadcast_transformation(self, translation, quaternion):
        ...
        t.header.frame_id = 'map'  # Reference frame (static)
        t.child_frame_id = 'drone'  # Moving frame (dynamic)
